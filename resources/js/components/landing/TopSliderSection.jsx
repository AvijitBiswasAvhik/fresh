    ...
    return (
        <>
            ...
            >
                ...
                <div className="carousel-inner overflow-hidden" style={{height: "300px"}}>
                    <div className="carousel-item" style={{height: "300px"}}>
                        <img
                            src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Lion_waiting_in_Namibia.jpg/1024px-Lion_waiting_in_Namibia.jpg"
                            className=""
