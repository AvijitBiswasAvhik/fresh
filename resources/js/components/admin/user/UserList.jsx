                                ...
                                <div className="user">
                                    <div className="admin-user-card">
                                        ...
                                        <div className="admin-user-details">
                                            <h5 className="user-name user-content">
                                                {el.name}
                                            </h5>
                                            <p className="form-text text-muted user-content">
                                                {el.email}
                                            </p>
                                            <p className="user-content">
                                                Current Order:{" "}
                                                {el.order && el.order.length}
                                            </p>
                                            <p className="user-content">
                                                Complete Order: 4
                                            </p>
                                            <p className="user-content">
                                                ...
                                                {el.order &&
                                                    el.order.reduce((p, c) => {
                                                        return (
                                                            p + Number(c.total_amount)
                                                        );
                                                    }, 0)}
                                            </p>
                                            <ul className="user-social-container">
                                            ...
                                            Contact NO: +88 01{Math.floor(Math.random()*10000000000)}
                                        </div>
                                        </div>
